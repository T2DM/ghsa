...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/ghsa/ghsa-settings.inc');
}

// Manage configuration in local development
// See https://docs.acquia.com/cloud/manage/code/config-d8
$config_directories['vcs'] = $app_root . '/../config/' . basename($site_path);

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_ghsa_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_ghsa_dev_default.inc';
}
// </DDSETTINGS>
